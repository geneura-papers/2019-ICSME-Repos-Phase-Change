...
\begin{abstract}
Software nowadays is almost exclusively developed using source control systems. Traditionally, the study of the evolution
  ...
  However, one of the essential characteristics needed to understand this type
  ...
  the events' size distributions.
  % (in this case, events are understood as  commits, that is, additions to the code by users).
  % - This is our choice and should be presented that way. Other people might use a different thing, like file size, author interactions or whatever - JJ
  ...
  We will use the concept of hypothesis tests for that
  purpose, that is, checking what is the likelihood that our data
  follows a  power law distribution  instead of some other with
  similar characteristics.

  The conclusions of these tests may not shed light on
